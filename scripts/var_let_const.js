...
console.log(bowl);
bowl = '콩' //'밥' 기존데이터를 제거하고 '콩' 새로운 데이터대입
...
var b;
var c;
console.log(a, b, c); //값정의안됨*3 undefined
a = 1; //var 안 쓴 이유? 위에서 이미 선언되었으니까
console.log(a); //실행 위치에 따라 다른 값 출력
b = 2;
c = 3;
console.log(a, b, c);
a = b; // b(2)변수값을 a변수에 대입(a변수 기존값 제거) a에 2가 대입됨
b = c; //c(3)를 b변수에 대입(b변수 기존값 제거) b에 3이 대입됨
...
num = 3;
console.log(`주문수량 ${num}개, 총 결제금액은 ${price*num}입니다.`);
//num변수의 데이터 종류는 
