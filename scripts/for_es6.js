...
console.log(study); //변수가 올바른지 확인용
...
const gnbClocne = gnbUl.cloneNode(true); //복제 (ctrl+C와유사)

mNav.appendChild(gnbClocne); //자식에 붙여넣기


// 데스크톱 로그인장바구니(login_cart > a*2) 복제해서 모바일 메뉴 위치(login_cart)에 붙여넣기
...
for(let i of mGnb){
    i.addEventListener('click',function(){
        console.log('클릭확인');
        mLnbHide()
        //height:max-content를 수치화한 속성=> scrollHeight
