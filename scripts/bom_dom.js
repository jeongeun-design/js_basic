// bom_dom.js
// 함수기초연습
function calc(num2){ //매개변수 생성
    let num1 = 2;
    let total = num1 + num2; //매개변수 대입위치
    console.log(`total=>${total}`)
};
calc(1000); //호출(매개변수 대입값입력)
calc(5);
calc('1');
...
document.write('<h1>메세지1</h1>')
document.write('<h2>메세지<br>2</h2>')
document.write('메세지3<br>')
...
txtId.style.backgroundColor = 'gray'
txtId.style.color = '#fff'
txtId.style.padding = '20px'
txtId.style.width = '150px'
...
console.log(txtIdQ); //null, undefined 오류 확인
// 변수 생성 -> 스타일적용
txtIdQ.style.backgroundColor = 'red'
